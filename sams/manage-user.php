            ...
            ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo SITEURL; ?>admin/delete-user.php?id=<?php echo $user_id ?>" class="btn-danger">Delete</a>

                                <!-- <a href="delete-admin.php?id=<?php //echo $id 
                                                                    ?>" class="btn-danger">Delete Admin</a> (or i can write this type)-->

                                <a href="<?php echo SITEURL; ?>admin/update-user.php?id=<?php echo $user_id ?>" class="btn-secondary">Update</a>
                            </td>
                        </tr>
            <?php
